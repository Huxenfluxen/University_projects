...
class BallPanel extends JPanel implements ActionListener {
    ...
    public BallPanel (int width, int height) {
		...
		ball2 = new Ball( width / 5, height / 2, 17, 12 );
		
		ball1.setColor(Color.magenta); // Sets another color than the default for the new ball
		ball2.setColor(Color.green);
		
		ball1.setDiameter(35); // Sets a new diameter to the ball
		ball2.setDiameter(5);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        ball1.action();  // Gör vad som är relevant med bollen
